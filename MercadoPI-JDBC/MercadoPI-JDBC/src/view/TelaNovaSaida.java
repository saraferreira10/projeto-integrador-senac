...
public class TelaNovaSaida extends javax.swing.JFrame {

    public TelaNovaSaida() {
        initComponents();
        setTitle("Saída");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            if (txtDescricao.getText().trim().isEmpty()) {
                ...
                Saida saida = new Saida((double) spnVenda.getValue(), data, txtDescricao.getText());
                SaidaDAO.adicionarSaida(saida);
                JOptionPane.showMessageDialog(null, "Saída cadastrada!");
                dispose();
            ...
            Logger.getLogger(TelaNovaSaida.class.getName()).log(Level.SEVERE, null, ex);
        }
